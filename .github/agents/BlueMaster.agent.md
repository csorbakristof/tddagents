...
- DO NOT hand off until all tests still pass after refactoring
...
3. Refactor incrementally, running tests after each meaningful change
4. Confirm all tests remain green throughout
